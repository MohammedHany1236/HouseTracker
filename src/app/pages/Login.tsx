    ...
    <div className="min-h-screen flex" style={{ backgroundColor: '#F5F7FA' }}>
      ...
      <div className="hidden lg:flex lg:w-1/2 p-12 flex-col justify-between" style={{ background: 'linear-gradient(135deg, #0F4C5C 0%, #1F7A8C 50%, #4FA3B1 100%)' }}>
        ...
        <div>
          ...
          <p className="text-xl text-white/90 mb-8">
            Sign in to access your personalized real estate dashboard and never miss a great deal.
          </p>
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-white">Track Properties</div>
                <div className="text-white/70 text-sm">Monitor thousands of listings 24/7</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ backgroundColor: 'rgba(46, 196, 199, 0.2)' }}>
              ...
              <div>
                ...
                <div className="text-white/70 text-sm">Get smart recommendations instantly</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ backgroundColor: 'rgba(46, 196, 199, 0.2)' }}>
              ...
              <div>
                <div className="text-white">Real-time Alerts</div>
                <div className="text-white/70 text-sm">Never miss a price drop or new listing</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h2 className="text-3xl mb-2" style={{ color: '#1A1A1A' }}>Sign In</h2>
            <p style={{ color: '#6B7280' }}>Access your real estate dashboard</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="#" className="text-sm" style={{ color: '#2EC4C7' }}>
                Forgot password?
              </a>
            </div>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white" style={{ color: '#6B7280' }}>Or continue with</span>
              </div>
            </div>
            ...
            <div className="text-center text-sm" style={{ color: '#6B7280' }}>
              ...
              <Link to="/signup" style={{ color: '#2EC4C7' }}>
                Sign up for free
              </Link>
            </div>
          </form>
